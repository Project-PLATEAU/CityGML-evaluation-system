...
<tr class="user-first-name-wrap">
	...
	<?php if ( !current_user_can( 'administrator' ) ) { ?>
		<td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ); ?>" disabled="disabled" class="regular-text" /></td>
	<?php }else{ ?>
		<td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ); ?>"  class="regular-text" maxlength="60" /></td>
	<?php }?>
	<!--2021 Project "PLATEAU" END-->
</tr>
...
<tr class="user-last-name-wrap">
	...
	<!--2021 Project "PLATEAU" START-->
	<?php if ( !current_user_can( 'administrator' ) ) { ?>
		<td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profileuser->last_name ); ?>" disabled="disabled" class="regular-text" /></td>
	<?php }else{ ?>
		<td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profileuser->last_name ); ?>"  class="regular-text" maxlength="60" /></td>
	<?php }?>
	<!--2021 Project "PLATEAU" END-->
</tr>
<!--2021 Project "PLATEAU" START-->
<tr class="user-nickname-wrap" hidden>
<!--2021 Project "PLATEAU" END-->
...
<tr class="user-display-name-wrap">
	...
	<td>
	    <!--2021 Project "PLATEAU" START-->
		<?php if ( !current_user_can( 'administrator' ) ) { ?>
			<select name="display_name" id="display_name" disabled="disabled">
		<?php }else{ ?>
	...
	<table class="form-table" role="presentation">
	<tr class="user-email-wrap" hidden>
		<th><label for="email"><?php _e( 'Email' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
		<td><input type="email" name="email" id="email" aria-describedby="email-description" value="<?php echo esc_attr( $profileuser->user_email ); ?>" class="regular-text ltr" maxlength="60" />
		<!--2021 Project "PLATEAU" END-->
		<?php
    ...
    <!--2021 Project "PLATEAU" START-->
	<tr class="user-url-wrap" hidden>
	<th><label for="url"><?php _e( 'Website' ); ?></label></th>
	<td><input type="url" name="url" id="url" value="<?php echo esc_attr( $profileuser->user_url ); ?>" class="regular-text code"  maxlength="60" /></td>
	<!--2021 Project "PLATEAU" END-->
	</tr>
	...
	<td>
		...
		<div class="wp-pwd hide-if-js">
			<span class="password-input-wrapper">
			    <!--2021 Project "PLATEAU" START-->
				<input type="password" name="pass1" id="pass1" class="regular-text" value="" autocomplete="off" data-pw="<?php echo esc_attr( wp_generate_password( 24 ) ); ?>" aria-describedby="pass-strength-result" maxlength="24" />
				<!--2021 Project "PLATEAU" END-->
			</span>
