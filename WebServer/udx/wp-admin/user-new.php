...
<script type="text/javascript">
 function incopy(formObj){
    formObj.elements["email"].value=formObj.elements["user_login"].value + "@aaa.com";
...
<!--2021 Project "PLATEAU" END-->
	<tr class="form-field form-required">
		...
		<!--2021 Project "PLATEAU" START-->
		<td><input name="user_login" type="text" id="user_login" value="<?php echo esc_attr( $new_user_login ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" onkeydown="incopy(this.form)" onMouseOut="incopy(this.form)" onMouseOver="incopy(this.form)" onkeyup="incopy(this.form)"/></td>
	</tr>
	<tr class="form-field form-required" hidden>
		<th scope="row"><label for="email"><?php _e( 'Email' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
		<td><input name="email" type="email" id="email" value="<?php echo esc_attr( $new_user_email ); ?>" maxlength="60" /></td>
	</tr>
	<?php if ( ! is_multisite() ) { ?>
	<tr class="form-field">
		<th scope="row"><label for="first_name"><?php _e( 'First Name' ); ?> </label></th>
		<td><input name="first_name" type="text" id="first_name" value="<?php echo esc_attr( $new_user_firstname ); ?>" maxlength="60" /></td>
	</tr>
	<tr class="form-field">
		<th scope="row"><label for="last_name"><?php _e( 'Last Name' ); ?> </label></th>
		<td><input name="last_name" type="text" id="last_name" value="<?php echo esc_attr( $new_user_lastname ); ?>" maxlength="60" /></td>
	</tr>
	<tr class="form-field" hidden>
		<th scope="row"><label for="url"><?php _e( 'Website' ); ?></label></th>
		<td><input name="url" type="url" id="url" class="code" value="<?php echo esc_attr( $new_user_uri ); ?>"  maxlength="60" /></td>
		<!--2021 Project "PLATEAU" END-->
	</tr>
		<?php
		...
		<td>
			...
			<div class="wp-pwd hide-if-js">
				...
				<span class="password-input-wrapper">
				    <!--2021 Project "PLATEAU" START-->
					<input type="password" name="pass1" id="pass1" class="regular-text" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" maxlength="24" />
					<!--2021 Project "PLATEAU" END-->
				</span>
