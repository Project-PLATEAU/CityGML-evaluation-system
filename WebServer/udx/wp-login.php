...
function retrieve_password() {
	...
	if ( empty( $_POST['user_login'] ) || ! is_string( $_POST['user_login'] ) ) {
		...
		if ( empty( $user_data ) ) {
			//2021 Project "PLATEAU" START
			$errors->add( 'invalid_email', __( '<strong>Error</strong>: There is no account with that username.' ) );
			//2021 Project "PLATEAU" END
		}
	} else {
	...
	if ( ! $user_data ) {
		//2021 Project "PLATEAU" START
		$errors->add( 'invalidcombo', __( '<strong>Error</strong>: There is no account with that username.' ) );
		//2021 Project "PLATEAU" END
		return $errors;
	}
...
switch ( $action ) {
	...
	case 'retrievepassword':
        ...
        //2021 Project "PLATEAU" START
		login_header( __( 'Lost Password' ), '<p class="message">' . __( 'Please enter your username. You will receive an email message with instructions on how to reset your password.' ) . '</p>', $errors );
		//2021 Project "PLATEAU" END
